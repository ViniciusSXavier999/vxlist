...
public class GameService {
	...
	// Vai devolver apenas os dados da minha entidade DTO, SEMPRE RESPEITANDO A ARQUITETURA.
	...
	public List<GameMinDTO> findAll(){
		 ...
		 * 
		 * todo objeto x original que era game, eu quero transformar ele em um "new gameMinDTO" passando x como argumento
		 * e no final eu uso o toList para voltar a ser uma lista.
		 * */
